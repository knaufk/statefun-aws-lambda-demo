...
public class Main {
    ...
    private static final class GreeterFn implements StatefulFunction {
        ...
        static final ValueSpec<Integer> SEEN = ValueSpec.named("seen")
                .thatExpireAfterWrite(Duration.ofDays(7))
                .withIntType();
        ...
        public CompletableFuture<Void> apply(Context context, Message message) {
            return CompletableFuture.runAsync(() -> {
                ...
                context.send(KinesisEgressMessage.forEgress(GREETS_EGRESS)
    ...
    public static void main(String... args) {
        ...
        StatefulFunctionSpec spec = StatefulFunctionSpec.builder(GreeterFn.TYPE)
    ...
    private static final class StateFunUndertow implements HttpHandler {
        ...
        private void onRequestBody(HttpServerExchange exchange, byte[] requestBytes) {
            try {
                ...
                exchange.dispatch();
                future.whenComplete((responseBytes, ex) -> {
                    if (ex != null) {
